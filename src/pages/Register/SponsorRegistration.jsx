        ...
        <div className="container mx-auto">
          ...
          >
            ...
            >
              ...
              >
                Devenez un Sponsor avec SOTRADONS
              </Title>
              <Paragraph className="text-lg mb-4">
                Rejoignez notre réseau de sponsors et bénéficiez de nombreux
                avantages pour votre entreprise. Votre soutien contribue
                directement aux projets de responsabilité sociétale, tout en
                offrant une visibilité accrue et un engagement à faible risque.
              </Paragraph>
              <div className="custom-divider mb-4"></div>
              <Paragraph className="text-lg mb-4">
                Pour devenir un sponsor chez SOTRADONS, vous devez remplir les
                conditions suivantes :
              </Paragraph>
              <ul className="conditions-list mb-4">
                <li>
                  Investir dans des projets socialement viables, alignés avec
                  les objectifs de développement durable et les normes de
                  qualité de SOTRADONS.
                </li>
                <li>
                  Appuyer des initiatives de responsabilité sociétale avec un
                  fort engagement envers la solidarité, la transparence et les
                  dons pour des causes humanitaires.
                </li>
                <li>
                  Bénéficier de la visibilité et de la reconnaissance associées
                  au soutien de projets qui font une différence positive dans la
                  communauté.
                </li>
                <li>
                  Travailler en partenariat avec SOTRADONS pour garantir une
                  gestion transparente des fonds et des ressources alloués aux
                  projets soutenus.
                </li>
              </ul>
              <Paragraph className="text-lg mb-4">
                En devenant sponsor, vous jouez un rôle essentiel dans le
                soutien et le développement d'initiatives sociales impactantes,
                tout en renforçant l'image de votre entreprise en matière de
