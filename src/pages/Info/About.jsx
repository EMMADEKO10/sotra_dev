            ...
            >
              <div className="space-y-6">
                ...
                <h2 className="area-title text-4xl font-extrabold leading-tight">
                  Nous sommes une organisation caritative mondiale à but non
                  lucratif.
                </h2>
                <p>
                  Les principes voyagent fréquemment loin, c'est
                  particulièrement agréable d'être accepté. Le bonheur est
                  nécessaire. Lorem ipsum dolor sit amet consectetur adipisicing
                  elit. Labore nesciunt ad suscipit iusto dolorum quae
                  recusandae quo illum libero excepturi, provident facere.
                  Delectus possimus cupiditate voluptatum.
                </p>
          ...
          >
            ...
            >
              <div className="item">
                ...
                <p>
                  Toujours des adieux de longueur, ajoutez le nombre de moments
                  qu'elle. Promesse de peu de boussole.
                </p>
              </div>
            </Col>
            <Col
          ...
          >
            ...
            >
              <div className="space-y-6">
                ...
                <h2 className="area-title text-4xl font-extrabold leading-tight">
                  Nous croyons que nous pouvons sauver plus de vies avec vous.
                </h2>
                <p>
                  Leur fin tout entier pourrait commencer par elle. Comportement
                  le confort une autre quinzaine de manger. La partialité avait
                  demandé à ses propres pianoforte en augmentant découvert.
                  Alors monsieur retard à depuis endroit entier au-dessus des
                  miles.
                </p>
                <h4 className="text-xl font-semibold">
                  Nos priorités stratégiques jusqu'en 2020 sont :
                </h4>
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    Protéger les associations caritatives contre les abus ou la
                    mauvaise gestion
                  </li>
                  <li>
                    Permettre aux administrateurs de gérer leurs associations
                    efficacement
                  </li>
                  <li>
                    Encourager une plus grande transparence et responsabilité
                  </li>
                </ul>
                <Button
                  type="primary"
      ...
      <div className="volunteer-area bg-gray-100 py-12">
        <div className="container mx-auto">
          ...
          <Carousel
            ...
            className="mt-8"
          >
            {["Jones Park", "Monal Spoa", "Shyra Poulsen", "Mack Joe"].map(
              (volunteer, index) => (
                <div
                  key={index}
                  className="item text-center space-y-4"
                >
                  <div className="relative">
                    <img
                      src="/assets/img/800x800.png"
