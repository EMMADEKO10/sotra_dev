            ...
            <div className="w-full lg:w-1/3 px-4">
              <aside>
                <div className="bg-white shadow-lg rounded-lg p-8 mb-10">
                  ...
                  <span className="text-gray-600">{`Fonds collectés : ${percent}%`}</span>
                </div>
                <div className="bg-white shadow-lg rounded-lg p-8 mb-10">
                  ...
                  <Input placeholder="Montant personnalisé" value={customAmount} onChange={handleCustomAmountChange} className="mt-4" />
                  <Button type="primary" className="mt-4 w-full" onClick={handleDonation} style={{ backgroundColor: '#3bcf93', borderColor: '#3bcf93' }}>Faire un don maintenant</Button>
                </div>
                <div className="bg-white shadow-lg rounded-lg p-8 mb-10">
