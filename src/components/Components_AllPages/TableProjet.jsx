...
const Table = () => {
    return (
        // <section className='bg-white dark:bg-dark lg:py-[120px]'>
                        ...
                        <div className='max-w-full overflow-x-auto'>
                            <table className='w-full table-auto'>
                                <thead className='text-center bg-primary'>
                                    <tr>
                                        <th className={TdStyle.ThStyle}> Projet </th>
                                ...
                                <tbody>
                                    <tr>
                                        <td className={TdStyle.TdStyle}>Suivi des fourages et amenagement des territoire</td>
