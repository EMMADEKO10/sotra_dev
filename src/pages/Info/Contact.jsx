            ...
            <div className="col-lg-7 contact-forms">
                ...
                <form action="assets/mail/contact.php" method="POST" className="contact-form">
                    ...
                    <div className="col-lg-12">
                        ...
                        <Input className="form-control" id="name" name="name" placeholder="Nom" type="text" />
                    ...
                    <div className="col-lg-12">
                        <div className="form-group">
                        <Input className="form-control" id="phone" name="phone" placeholder="Téléphone" type="text" />
                        <span className="alert-error"></span>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="col-lg-12">
                        ...
                        <textarea className="form-control" id="comments" name="comments" placeholder="Parlez-nous de votre projet *"></textarea>
                        </div>
                    </div>
                    </div>
                    <div className="row">
