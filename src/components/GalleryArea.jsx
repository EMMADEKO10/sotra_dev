              ...
              <div className="container">
                  <div className="row">
                      <div className="col-lg-12">
                          <div className="gallery-items-area inner-title">
                                      ...
                                      <div id="portfolio-grid" className="gallery-items colums-3">
                                          ...
                                          <div className="pf-item wide">
                                              ...
                                              <img src="/media/african-kid-marketplace.jpg" alt="Thumb" />
                                                  ...
                                                  <div className="view">
                                                  <a href="/media/2-students-in-World-Bank-ACEESD.jpg" className="item popup-link"><i className="fa fa-plus"></i></a>
                                                  </div>
                                              </div>
                                          </div>
                                          <div className="pf-item">
                                              ...
                                              <img src="/media/l’éducation.jpg" alt="Thumb" />
                                                  ...
                                                  <div className="view">
                                                  <a href="/media/african-kid-marketplace.jpg" className="item popup-link"><i className="fa fa-plus"></i></a>
                                                  </div>
                                              </div>
                                          </div>
                                          <div className="pf-item">
                                              <div className="item-inner">
                                              <img src="/media/Photo _ Neil Palmer (CIAT) Flickr CC.jpeg" alt="Thumb" />
                                                  <div className="overlay">
                                                      <h4><a href="#">Education des enfants</a></h4>
                                                      <span className="cats">Pauvre</span>
                                                  </div>
                                                  <div className="view">
                                                  <a href="/media/people-repairing-computer-chips.jpg" className="item popup-link"><i className="fa fa-plus"></i></a>
                                                  </div>
                                              </div>
                                          </div>
                                          <div className="pf-item">
                                              ...
                                              <img src="/media/l’eau pour tous.jpg" alt="Thumb" />
                                                  ...
                                                  <div className="view">
                                                  <a href="/media/l’éducation.jpg" className="item popup-link"><i className="fa fa-plus"></i></a>
                                                  </div>
                                              </div>
                                          </div>
                                          <div className="pf-item">
                                              <div className="item-inner">
                                              <img src="/media/medium-shot-woman-posing-outdoors.jpg" alt="Thumb" />
                                                  <div className="overlay">
                                                      <h4><a href="#">Reconstruire la maison</a></h4>
                                                      <span className="cats">Pauvre</span>
                                                  </div>
                                                  <div className="view">
                                                  <a href="/media/side-view-people-doing-pottery.jpg" className="item popup-link"><i className="fa fa-plus"></i></a>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
